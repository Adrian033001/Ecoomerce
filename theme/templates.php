        ...
        <div class="row">
          <div class="col-md-4 clearfix">
            <div class="logo pull-left">
              <a href="<?php echo web_root?>"><img src="images/home/logo.jpg" alt="" width="300" height="100"/></a>
            </div> 
          </div>
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="row">
          ...
          <p class="pull-left">DESIGNED BY <span><a target="_blank" href="#">GROUP13</a></span></p>
        </div>
      </div>
    </div>
