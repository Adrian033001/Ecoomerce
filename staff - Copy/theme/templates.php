        ...
        <nav class="navbar navbar-default navbar-static-top  " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                 ...
                 <a class="navbar-brand"  href="<?php echo web_root; ?>staff/index.php" >VAPETREK</a>
            </div>
            <!-- /.navbar-header -->
...
<?php
 $user = New stafflog();
$singleuser = $user->single_user($_SESSION['suid']);
...
?> 
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-acnt">
                      ...
                      <div class="divtxt">
                        <li><a href="<?php echo web_root; ?>staff/staff/index.php?view=edit&id=<?php echo $_SESSION['suid']; ?>"> <?php echo $singleuser->name; ?> </a>
                      <li><a title="Edit" href="<?php echo web_root; ?>staff/staff/index.php?view=edit&id=<?php echo $_SESSION['suid']; ?>"  >Edit My Profile</a>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    ...
                    <!--     <li>
						...
						<li>
                            <a href="<?php echo web_root; ?>staff/damage/index.php" ><i class="fa fa-trash-o" style="font-size:20px;color:red"></i> Damaged items </a>
                          
                        </li>
						<li>
                             <a href="<?php echo web_root; ?>staff/delivery/index.php" ><i class="fa fa-list-alt fa-fw"></i>  Delivery </a>
                    ...
                    <div class="modal fade" id="usermodal" tabindex="-1">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <form action="<?php echo web_root; ?>staff/user/controller.php?action=photos" enctype="multipart/form-data" method=
                                "post">
                                    <div class="modal-body">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-12">
                                                <div class="rows">
                                                    <img title="profile image" width="500" height="360" src="<?php echo web_root.'staff/user/'.$singleuser ->USERIMAGE ?>">  
