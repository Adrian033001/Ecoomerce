...
<hr/>
 <h4><strong>Order Information</strong></h4>
				...
				<?php
				 $subtot=0;
				  $query = "SELECT * 
						...
						echo '<tr>';  
				  		echo '<td ><img src="'.web_root.'staff/product/'. $result->IMAGES.'" width="60px" height="60px""/></td>';
		...
		<?php if($cur->ORDEREDSTATS!='Pending' || $cur->ORDEREDSTATS!='Cancelled' ){ ?> 
                ...
                <button  id="btnPrint" type="button"  class="btn btn_fixnmix pull-right "><span class="glyphicon glyphicon-print" ></span> Print</button>    	
