                    ...
                    <div class="tab-pane active" id="home">
                        ...
                        <div class="table-responsive" style="margin-top:5%;">
                                ...
                                id="example" style="font-size:12px">
                                    ...
                                    <tbody>
                                        <?php 
                                                                  ...
                                                                  WHERE  `CUSTOMERID`=".$_SESSION['CUSID'] ." GROUP BY `ORDEREDNUM` ORDER BY   `ORDEREDNUM` desc ";
                                                                  $mydb->setQuery($query);
                            ...
                            <a href="#"  title="View list Of ordered products"  class="orderid   "  data-target="#myOrdered" data-toggle="modal" data-id="<?php echo  $result->ORDEREDNUM; ?>"><i class="fa fa-info-circle fa-fw"></i> view orders</a> 
                                            ...
                                            <td>
                                            <?php echo  $result->ORDEREDSTATS; 											if($result->ORDEREDSTATS=='Pending'){				  				echo '</br><a href="controller.php?action=cancel&id='.$result->ORDEREDNUM.'&customerid='.$result->CUSTOMERID.'&heyo=cancel" class="btn btn-danger btn-xs">Cancel</a>';			  	 		}elseif($result->ORDEREDSTATS=='Confirmed'){				  	 			echo '</br>								<a href="#"  class="btn btn-success btn-xs" disabled>Packed</a>';				  	 		 			  	 		}elseif($result->ORDEREDSTATS=='Prepaired'){			  	 			 echo '</br><a href="#"  class="btn btn-success btn-xs" disabled>To be delivered</a>';										  	 		}elseif($result->ORDEREDSTATS=='Delivery'){			  	 			 echo '</br><a href="#"  class="btn btn-success btn-xs" disabled>Out for delivery</a>';										  	 		}elseif($result->ORDEREDSTATS=='Delivered'){			  	 			 echo '</br><a href="#"  class="btn btn-success btn-xs" disabled>Delivered</a>';										  	 		} else{			  	 			 echo '</br><a  href="#"  class="btn btn-danger btn-xs" disabled>Cancelled</a>';										  	 		}?></td>
                                            <td>
