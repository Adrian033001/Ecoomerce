...
<section id="cart_items">
    ...
    <div class="col-md-6 pull-left">
      ...
      <div class="col-md-8 col-lg-10 col-sm-3" style="float:left">
        <?php echo $singlecustomer->CUSHOMENUM . ' ' . $singlecustomer->STREETADD . ' ' .$singlecustomer->BRGYADD . ' ' . $singlecustomer->CITYADD . ' ' .$singlecustomer->PROVINCE . ' ' .$singlecustomer->ZIPCODE; ?>
      </div>
    </div>
      ...
      <div class="table-responsive cart_info"> 
              ...
              ?>
                ...
                <div class="  pull-right">
                  <p>
                  <div align="right">  Total Price : &#8369 <span id="sum">0.00</span></div>
                   <div align="right"> Delivery Fee : &#8369 <span id="fee">60.00</span></div>
                   <div align="right" > Overall Price : &#8369 <span id="overall"><?php echo number_format($tot);?>.00</span></div>
