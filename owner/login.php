...
if(isset($_POST['btnLogin'])){
  ...
  //it creates a new objects of member
    ...
    if ($res==true) {
       message("You logon as ".$_SESSION['ouname'].".","success");
      
           redirect(web_root."owner/products/index.php");
      
    }else{
      message("Invalid Username/Password. Please try again.", "error");
