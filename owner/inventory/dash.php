 ...
 <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    ...
                    <!--     <li>
                        ...
                        <li>
                             <a href="<?php echo web_root; ?>owner/inventory/damaged/index.php"> Damaged Items </a>
           
                        </li>
						<li>
                            <a href="<?php echo web_root; ?>owner/inventory/replenishment/index.php" > Replenishments </a>
                          
                        </li>
                        <li>
                             <a href="<?php echo web_root; ?>owner/inventory/stocks/index.php" > Stocks Available </a>
                  </li>
                           
                         <li>
                             <a href="<?php echo web_root; ?>owner/inventory/low/index.php" > Low Stocks </a>
            
                        </li>												<!--<li>                             <a href="<?php echo web_root; ?>owner/inventory/expired/index.php" > Expired Products </a>                                    </li>                         <li>                             <a href="<?php echo web_root; ?>owner/inventory/out/index.php" > Phased Out Products </a>                                    </li>-->
