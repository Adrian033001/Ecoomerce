<?php  
  ...
  $user = New ownerlog();
  $singleuser = $user->single_user($owner_id);
                    ...
                    <div class="col-md-8">
                      ...
                      <!-- <div class="col-md-8"> -->
                         ...
                         <input class="form-control input-sm" id="USERID" name="USERID" placeholder=
                            "Account Id" type="Hidden" value="<?php echo $singleuser->owner_id; ?>">
                   <!--    </div>
                    </div>
                  </div>      -->      
                      ...
                      <div class="col-md-8">
                        <input name="deptid" type="hidden" value="">
                         <input class="form-control input-sm" id="U_PASS" name="U_PASS" placeholder=
                            "Account Password" type="text" value="<?php echo $singleuser->pass; ?>" >
                      </div>
                    </div>
                  </div>
                      ...
                      <div class="col-md-8">
                        <input name="deptid" type="hidden" value="">
                         <input class="form-control input-sm" id="contact_no" name="contact_no" placeholder=
                            "Account Password" type="number" min="09000000001" max="09999999999" value="<?php echo $singleuser->contact_no; ?>" required>
                      </div>
                    </div>
                  </div>
