        ...
        <nav class="navbar navbar-default navbar-static-top  " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                 ...
                 <a class="navbar-brand"  href="<?php echo web_root; ?>admin/index.php" >VAPTREK</a>
            </div>
            <!-- /.navbar-header -->
                 ...
                 <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li><a href="<?php echo web_root; ?>admin/category/index.php?view=add"><i class="fa fa-list-alt  fa-fw"></i> Category</a>
                            ...
                            # code...
                        ?>
                         <li><a href="<?php echo web_root; ?>admin/user/index.php?view=add"><i class="fa fa-user  fa-fw"></i> Admin</a>
                            </li>
                ...
                <div class="sidebar-nav navbar-collapse">
                    ...
                    <!--     <li>
                       ...
                       <!--   <li>
                         ...
                         <li>
                            <a href="<?php echo web_root; ?>admin/sales/index.php" ><i class="fa  fa-file-text fa-fw"></i> Report </a>
