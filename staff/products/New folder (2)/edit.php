       ...
       <form class="form-horizontal span6" action="controller.php?action=edit" method="POST"  />
        ...
        <div class="form-group">
                    <div class="col-md-8">
                      ...
                      "PRODNAME">Productname:</label>

                      <div class="col-md-8">
                            <input class="form-control input-sm" id="PRODNAME" name="PRODNAME" placeholder=
                            "Owner Name" type="text" value="<?php echo $singleproduct->PRODNAME; ?>" disabled>
                      </div>
                    </div>
                  </div>  
                    ...
                    <div class="col-md-8">
                      ...
                      <textarea class="form-control input-sm" id="PRODESC" name="PRODESC" cols="1" rows="3" disabled><?php echo $singleproduct->PRODESC; ?>
                      </textarea>
                  ...
                  <div class="form-group">
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                       <select class="form-control input-sm" name="CATEGORY" id="CATEGORY"disabled>
